...
import { X, User, Phone, GraduationCap, Star } from "lucide-react";
...
export function CallMeModal({ isOpen, onClose }: CallMeModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Call me form data:", formData);
    onClose();
  };
            ...
            <div className="bg-white rounded-xl shadow-xl p-4 md:p-8 border border-gray-100">
              <div className="mb-4 md:mb-6">
                ...
                <p className="text-primary text-base md:text-lg font-semibold mb-1">
                  Size en kısa sürede geri dönüş yapalım!
                </p>
                ...
                <p className="text-xs md:text-sm text-gray-700 mt-1 md:mt-2 font-medium">
                  Bilgilerinizi paylaşın, sizi arayalım!
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full h-10 md:h-12 text-base md:text-lg font-bold bg-primary hover:bg-primary/90"
                >
                  BENİ ARAYIN
                </Button>
              </form>
